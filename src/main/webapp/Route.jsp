				...
				<form name="form1" action="./Route1.jsp">
					...
					<div id="divHead">
						...
						<table align="center">
							...
							<tr>
								...
								<td><input type="text" name="start" maxlength="30"
									onkeyup="alp1(this)" onkeydown="alp1(this)" /></td>
							</tr>
							<tr>
								<td><label> Ending Station </label></td>
								<td><input type="text" name="end" maxlength="30"
									onkeyup="alp1(this)" onkeydown="alp1(this)" /></td>
							</tr>
							<tr>
								<td><label> Total Distance (km) </label></td>
								<td><input type="text" name="totalkm" maxlength="5"
					...
					<div id="divTable" align="center" style="">
						...
						<table id="table1" border="1" bordercolor=#333333>
							...
							<tr>
								<td>1</td>
								<td><input type="text" name="km1" size="8" maxlength="5"
									onkeyup="num(this)" onkeydown="num(this)" /></td>
								<td><input type="text" name="station1" maxlength="30"
									onkeyup="alp1(this)" onkeydown="alp1(this)" /></td>
							</tr>
							<tr>
								<td>2</td>
								<td><input type="text" name="km2" size="8" maxlength="5"
									onkeyup="num(this)" onkeydown="num(this)" /></td>
								<td><input type="text" name="station2" maxlength="30"
									onkeyup="alp1(this)" onkeydown="alp1(this)" /></td>
							</tr>
							<tr>
								<td>3</td>
								<td><input type="text" name="km3" size="8" maxlength="5"
									onkeyup="num(this)" onkeydown="num(this)" /></td>
								<td><input type="text" name="station3" maxlength="30"
									onkeyup="alp1(this)" onkeydown="alp1(this)" /></td>
							</tr>
							<tr>
								<td>4</td>
								<td><input type="text" name="km4" size="8" maxlength="5"
									onkeyup="num(this)" onkeydown="num(this)" /></td>
								<td><input type="text" name="station4" maxlength="30"
									onkeyup="alp1(this)" onkeydown="alp1(this)" /></td>
							</tr>
							<tr>
								<td>5</td>
								<td><input type="text" name="km5" size="8" maxlength="5"
									onkeyup="num(this)" onkeydown="num(this)" /></td>
								<td><input type="text" name="station5" maxlength="30"
									onkeyup="alp1(this)" onkeydown="alp1(this)" /></td>
							</tr>
							<tr>
								<td>6</td>
								<td><input type="text" name="km6" size="8" maxlength="5"
									onkeyup="num(this)" onkeydown="num(this)" /></td>
								<td><input type="text" name="station6" maxlength="30"
									onkeyup="alp1(this)" onkeydown="alp1(this)" /></td>
							</tr>
						...
						<p align="center">
							<INPUT type="button" value="Add Another Station"
