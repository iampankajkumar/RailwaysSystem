				...
				<form name="form1" action="./UserReg1.jsp">
					...
					<table>
						<tr>
							...
							<td><input type="text" name="fname" value="" maxlength="15"
								onkeyup="alp(this)" onkeydown="alp(this)" title="First Name" />
								<span style="color: red;">*</span></td>
							<td><label> Last Name </label></td>
							<td><input type="text" name="lname" value="" maxlength="15"
								onkeyup="alp(this)" onkeydown="alp(this)" /></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" id="datepicker" title="YYYY/MM/DD"
								name="dob" readonly="readonly" /> <span style="color: red;">*</span>
							</td>
						...
						<tr>
							...
							<td><input type="text" name="email" maxlength="30"
								onkeyup="EmailInsert(this);" onkeydown="EmailInsert(this);"
								onblur="validEmail(this);" /> <span style="color: red;">*</span></td>
						...
						<tr>
							...
							<td><input type="text" name="credit" maxlength="16"
								onkeyup="num(this)" onkeydown="num(this);" /> <span
						...
						<tr>
							...
							<td><input type="text" name="city" onkeyup="alp1(this)"
								onkeydown="alp1(this)" /></td>
						</tr>
						<tr>
					...
					<table border="0">
						<tr>
							...
							<td><input type="text" name="userid"
								value=<%String sql1 = "select MAX(User_Id) + 1 from reg_user";
...
readonly="readonly" /></td>
						...
						<tr>
							...
							<td><input type="password" id="pass1" name="password1"
								maxlength="6" /> <span style="color: red;">*</span></td>
						</tr>
						<tr>
					...
					<span style="color: red;">Field Marked With * Should be
						field</span> <br /> <br />
					<p align="center">
