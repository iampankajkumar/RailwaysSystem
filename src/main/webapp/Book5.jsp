	...
	<div id="templatemo_wrapper">
		...
		<div id="templatemo_content">
			...
			<div>
					...
					int pnrno = 0;
								...
								try {
									...
									PdfWriter.getInstance(doc,
											new FileOutputStream(file_path1 + proj + "/WebContent/pdf/Ticket.pdf"));
									...
									String pnrdetails = "PNR Number: " + pnrno
											+ "                                                                                Date="
											+ date_book;
									...
									for (int i = 1; i <= no; i++) {
										...
										String sql3 = "update " + coach + " set " + SEAT + _seatno1 + " ='" + pnrno
												+ "' where train_no=" + tno + " and dep_date='" + date_dep + "'";
				...
				<h3>
					BOOKING SUCCESSFULL WITH PNRNO: <span style="color: red;"> <%=pnrno%></span>
					<br /> <br /> <br />
				</h3>
				<span
					style="color: red; font-size: 16px; font-weight: bold; font-style: italic;">
					Right Click on the below link and select <span
					style="color: black;"> Save Target as.. or Save Link as.. </span> <br />
					To Download the Ticket in pdf format <br /> <br />
				</span>
				<%
