		...
		<div id="templatemo_content">
			...
			<div>
				...
				<p style="color: maroon; font-size: 16px; font-weight: bold;">
					Please drop us a line! <br /> If you have a query, an idea or a
					suggestion, we would be most happy to listen and will do our best
				...
				<form name="form1" action="feedback1.jsp">
					...
					<p align="center">
						<input type="button" value="Submit" onclick="valid()"> <input
