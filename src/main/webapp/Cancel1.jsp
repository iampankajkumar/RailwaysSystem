		...
		<div id="templatemo_content">
			...
			<div align="center">
				...
				<form name="form1" action="./Cancel2.jsp">
					...
					%>
					<h3>
						<span style='color: red;'> Ticket Booked By Other User
							Cannot Proceed </span>
					</h3>
					<input type='button' Value='OK'
						onclick="parent.location='Cancel.jsp'" />
					<%
						break block;
											}
											...
											out.println(
													"<th align='left' colspan='6' style='color:white'> Train Details : </th></tr>");
											out.println(
													"<tr bgcolor=#333333 style='color:white'>	<th> Train No</th> <th> Train Name</th> <th> Type</th> <th> Source Station</th><th> Destination Station</th><th> Distance</th>	</tr>");
											out.println("<tr>");
											out.println("<td>" + rs.getInt("train_no") + "</td><td>" + rs.getString("train_name")
													+ "</td><td>" + rs.getString("type") + "</td><td>"
													+ rs.getString("s_station_name") + "</td><td>" + rs.getString("d_station_name")
													+ "</td><td>" + rs.getInt("distance") + "</td>");
											out.println("</tr>");
											out.println("</table>");

											out.println("<table border='1' bordercolor=#333333>");
											out.println(
													"<th align='left' colspan='5' bgcolor=#333333 style='color:white'> Reservation Details : </th>");
											out.println(
													"<tr bgcolor=#333333 style='color:white'>	<th> PNR No</th> <th> Booked By</th><th> Booked Date</th><th> Departures On</th><th> Class Type</th>	</tr>");
											out.println("<tr>");
											out.println("<td>" + rs.getInt("PNR") + "</td><td>" + rs.getString("name") + "</td><td>"
													+ rs.getDate("book_date") + "</td><td>" + rs.getDate("dep_date") + "</td><td>"
													+ class1 + "</td>");
											out.println("</tr>");
											out.println(
													"<tr bgcolor=#333333 style='color:white'><th> Adults </th> <th> Childern </th><th> Boarding At </th><th> Reserv UPTO</th><th> Travel KM</th></tr>");
											out.println("<tr>");
											out.println("<td>" + rs.getInt("adult") + "</td><td>" + rs.getInt("child") + "</td><td>"
													+ rs.getString("board_station") + "</td><td>" + rs.getString("dest_station")
													+ "</td><td>" + rs.getInt("total_km") + "</td>");
											out.println("</tr>");
											out.println("</table>");
					...
					%>
					<h3>
						<span style='color: red;'> PNR NO DOES NOT EXIST TRY AGAIN
						</span>
					</h3>
					<input type='button' Value='OK'
						onclick="parent.location='Cancel.jsp'" />
					<%
						break block;
										...
										out.println("<table border='1' bordercolor=#333333>");
										out.println(
												"<th align='left' colspan='7' bgcolor=#333333 style='color:white'> Passenger Details : </th>");
										out.println(
												"<tr bgcolor=#333333 style='color:white'><th> Select </th>	<th> Coach No</th> <th> Seat No</th><th> Name </th><th> Sex</th><th> Age</th><th> Status</th>	</tr>");

										int i = 1;
										while (rs.next()) {

											out.println("<tr style='color:blue; font-weight:bold'>");
											out.println("<td><input name='seat' type='checkbox' tabindex='" + i + "' value='"
													+ rs.getString("seat_no") + "'</td>");
										...
										out.println("</table>");
										out.println("<input type='button' value='Conform Cancellation' onclick='validate(" + (i - 1)
												+ ")'>"); //Passing No Of seats (i) to the function
