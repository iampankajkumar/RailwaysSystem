				...
				<div align="center">
					<form name="form1" action="./admincancel.jsp">
						...
						<br /> <label style="font-weight: bold; color: red;">
							Select A Date To View Cancellations</label>
						<p>
						...
						<div>
							<%
								tryblock : try {
												...
												String sql1 = "select distinct c.PNR, c.coach_no, c.seat_no, c.name, c.sex, c.quota, c.amount, c.status, u.name from cancel_info c, reg_user u where c.user_id=u.user_id and c.cancel_date='"
														+ date + "'; ";
												...
												out.println(
														"<th align='left' colspan='8' style='color:white'> Cancellation Details : </th> </tr>");
												out.println(
														"<tr bgcolor=#333333 style='color:white'>	<th> PNR No</th> <th> Coach No</th> <th> Seat No</th> <th> Passenger </th><th> Gender</th><th> Quota</th><th> Amount</th><th> Status</th></tr>");
												...
												while (rs.next()) {
													...
													out.println("<td>" + rs.getInt(1) + "</td><td>" + rs.getString(2) + "</td><td>"
															...
															+ rs.getString(7) + "</td><td>" + rs.getString(8) + "</td>");
													out.println("</tr>");
												}
												out.println("</table>");
