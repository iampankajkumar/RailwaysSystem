		...
		<div id="templatemo_content">
			...
			<div>
				...
				<form name="form1" action="./TrainSchedule.jsp">
					<h1 align="center">New Train Details Addition</h1>
					...
					<div id="divHead">
						...
						<table id="table1" align="center" style="font-weight: bold;">
							...
							<tr>
								...
								<td><input type="text" name="trainno" value="<%=tno%>"
							...
							<tr>
								...
								<td>
									<!-- To forward the id's fetched from backend --> <input
									type="hidden" name="srcid" value=<%=sid%>> <input
									type="hidden" name="destid" value=<%=did%>> <input
									type="hidden" name="km" value=<%=km%>> <input
									type="text" name="src" value=<%=src%> readonly="readonly"
									tabindex="-1" />
								</td>
							</tr>
							<tr>
								<td><label> Destination </label></td>
								<td><input type="text" name="dest" value=<%=dest%>
									readonly="readonly" tabindex="-1" /></td>
							</tr>
							<tr>
								<td><label> Distance </label></td>
								<td><input type="text" value=<%=km%> readonly="readonly"
									tabindex="-1" /></td>
							</tr>
							<tr>
								<td><label> Train Name </label></td>
								<td><input type="text" name="tname" maxlength="30"
									onkeyup="alp1(this)" onkeydown="alp1(this)" /></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td align="left"><input type="checkbox" name="days"
									value="mon" /> Monday<br> <input type="checkbox"
									name="days" value="tue" /> Tuesday<br> <input
									type="checkbox" name="days" value="wed" /> Wednesday<br>
									...
									<input type="checkbox" name="days" value="sun" /> Sunday</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" name="sl" value="0" size="4"
									maxlength="4" onkeyup="num(this)" onkeydown="num(this)"
									onchange='check(this)' onblur='empty(this)' /></td>
							</tr>
							<tr>
								<td><label> AC First Class </label></td>
								<td><input type="text" name="a1" value="0" size="4"
									maxlength="4" onkeyup="num(this)" onkeydown="num(this)"
									onblur='empty(this)' /></td>
							</tr>
							<tr>
								<td><label>AC 2 Tier </label></td>
								<td><input type="text" name="a2" value="0" size="4"
									maxlength="4" onkeyup="num(this)" onkeydown="num(this)"
									onblur='empty(this)' /></td>
							</tr>
							<tr>
								<td><label> AC 3 Tier </label></td>
								<td><input type="text" name="a3" value="0" size="4"
									maxlength="4" onkeyup="num(this)" onkeydown="num(this)"
									onblur='empty(this)' /></td>
							</tr>
						</table>
