		...
		<div id="templatemo_content">
			...
			<div align="center">
				<form name="form1">
					...
					<br />
					<p>
						<label> Enter the 10 digit PNR No of the ticket to know
							The exact Status of the Reservation </label> <br /> <br /> <input
							name="pnr1" type="text" size="3" maxlength="3" /> - <input
							name="pnr2" type="text" size="7" maxlength="7" /><br /> <input
							type="button" value="Get Status" onclick="validate()" /> <input
