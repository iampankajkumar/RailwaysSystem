...
<script type="text/javascript">
	...
	function max() {
		...
		if (parseInt(document.form1.adult.value)
				+ parseInt(document.form1.child.value) > 6) {
	...
	function valid() { //Validating before submiting
		...
		if (ele1.value == 0) {
			...
			if (parseInt(document.form1.adult.value)
					+ parseInt(document.form1.child.value) == 0) {
					...
					<div align="center">
						...
						<div align="left">
							<table border="1" bordercolor=#333333>
								<tr bgcolor=#333333>
									<th colspan="6" align="left" style="color: white;">
										Selected Train :</th>
								</tr>
								...
								%>
								<tr>
									<td><input type="text" name="tno" size="3"
										value="<%=rs.getString("train_no")%>" readonly="readonly"
										tabindex="-1" /></td>
									<td><input type="text" size="18"
										value="<%=rs.getString("train_name")%>" readonly="readonly"
										tabindex="-1" /></td>
									<td><input type="text" size="10"
										value="<%=rs.getString("type")%>" readonly="readonly"
										tabindex="-1" /></td>
									<td><input type="text" name="date1" size="9"
										value="<%=rs.getDate("dep_date")%>" readonly="readonly"
										tabindex="-1" /></td>
									<td><input type="text" size="13"
										value="<%=rs.getString("s_station_name")%>"
										readonly="readonly" tabindex="-1" /></td>
									<td><input type="text" size="13"
										value="<%=rs.getString("d_station_name")%>"
										readonly="readonly" tabindex="-1" /></td>
								</tr>
					...
					<table border='1' bordercolor=#333333>
						<tr>
							...
							<td><select id="src1" name="src" onchange="destination()">
									...
									<%
										while (rs.next()) {
															out.println("<option value=" + rs.getInt("station_id") + ">"
																	+ rs.getString("station_name") + "</option>");
					...
					<div align="center">
						...
						<table border="1" bordercolor=#333333>
							...
							<tr>
								...
								<td><select id="select1" onchange="getvalue()">
										<option value="0">--Please Select--</option>
								...
								</select> <input name="clas" type="hidden" value="sl"> <!-- JavaScript Over writes the value at the onchange event of select -->
								</td>
							</tr>
							<tr>
								<td bgcolor=#333333 style="color: white; font-weight: bold;">
								...
								<td><input type="text" name="adult" value="0" size="4"
									maxlength="2" onblur="empty(this)" onkeyup="num(this)"
									onkeydown="num(this)" /> <span style="color: red;"></span></td>
							</tr>
							<tr>
								<td bgcolor=#333333 style="color: white; font-weight: bold;">
									<label> No Of Children</label>
								</td>
								<td><input type="text" name="child" value="0" size="4"
									maxlength="2" onblur="empty(this)" onchange="max()"
