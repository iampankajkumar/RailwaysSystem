...
<link title="theme" type="text/css"
	href="timepicker/jquery-ui-1.8.17.custom.css" media="screen"
	rel="Stylesheet" id="themeCSS" />
...
<script type="text/javascript">
	$(document).ready(
			function() {
				$('#timestart').timepickr(
						{
							rangeMin : [ '00', '05', '10', '15', '20', '25',
									'30', '35', '40', '45', '50', '55' ],
							convention : 24
						}).focus(); //timestart.timepickr
			}); //document ready
</script>
		...
		<div id="templatemo_content">
			...
			<div>
				...
				<form name="form1" action="./TrainSchedule1.jsp">
					...
					<input type="hidden" name="srcid" value=<%=srcid%> /> <input
						type="hidden" name="destid" value=<%=destid%> /> <input
						type="hidden" name="km" value=<%=km%> /> <input type="hidden"
						name="sl" value=<%=sl%> /> <input type="hidden" name="a1"
						value=<%=a1%> /> <input type="hidden" name="a2" value=<%=a2%> />
					...
					<div id="divHead">
						...
						<table align="center">
							...
							<tr>
								...
								<td><input type="text" name="trainno" value="<%=trainno%>"
							...
							<tr>
								...
								<td><input type="text" value="<%=src%>" readonly="readonly"
									tabindex="-1" /></td>
							</tr>
							<tr>
								<td><label> Destination </label></td>
								<td><input type="text" value="<%=dest%>"
									readonly="readonly" tabindex="-1" /></td>
							</tr>
						</table>
					</div>
					...
					<div id="divTable" align="center" style="">
						...
						<table id="table1" border="1" bordercolor=#333333>
							...
							%>
							<tr>
								<td><input type="text" name="station<%=i%>" size="4"
									readonly="readonly" tabindex="-1"
									value="<%=rs.getInt("station_id")%>" /></td>
								<td><input type="text" size="5" readonly="readonly"
									tabindex="-1" value="<%=rs.getInt("km")%>" /></td>
								<td><input type="text" readonly="readonly" tabindex="-1"
									value="<%=rs.getString("station_name")%>" /></td>
								<td><input type="text" id="timestart<%=i%>"
									readonly="readonly" name="arv<%=i%>" size="8" maxlength="5"
									onkeyup="num2(this)" onkeydown="num2(this)"
									style="font-weight: bold; background-color: white;" /></td>
								<td><input type="text" id="timestart<%=i + 20%>"
									readonly="readonly" name="dep<%=i%>" size="8" maxlength="5"
									onkeyup="num2(this)" onkeydown="num2(this)"
									style="font-weight: bold; background-color: white;" /></td>
							</tr>
							<%
