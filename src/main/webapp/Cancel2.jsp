		...
		<div id="templatemo_content">
			...
			<div>
					...
					int pnrno = 0;
								...
								try {
									...
									for (int i = 0; i < seats.length; i++) {
										...
										String sql3 = "insert into cancel_info values(" + pnrno + ",'" + coach_no + "','" + sno
												+ "','" + name + "','" + sex + "','" + age + "','" + quota + "','" + amount
												+ "','" + status + "','" + uid + "',now());";
										...
										String sql5 = "update " + coach_no + " set " + coach_seat + "=NULL where train_no="
												+ trainno + " and dep_date='" + dep_date + "' ";
				...
				<%
										...
										String sql8 = "update ticket_book set no_seats=" + final_no_seats + " where pnr="
												+ pnrno + " ";
										...
										String query = "update ticket_book set adult=" + no_adult + ", child=" + no_child
												+ " where pnr=" + pnrno + " ";
				...
				<%
									...
									loopi: for (int i = 1; i <= coach_seats; i++) { //loopi to check all the seats in a particular coach
										...
										for (int j = 1; j <= no_wait; j++) { //To Fetch The Waiting List No's into wait[]
											String w = "wait_" + j;
											String sql9 = "select " + w + " from " + coach + " where train_no=" + trainno
										...
										String s = "Sno_" + i;
										String sql10 = "select " + s + " from " + coach + " where train_no=" + trainno
												+ " and dep_date='" + dep_date + "';";
										...
										while (rs.next()) {
											if (rs.getString(1) == null) { //If The Seat In The Coach Is empty Then Waiting List upgrades
												...
												if (pnr[wno] == null || wait[wno] == "") { //If waiting list contains no PNR no then to exit loopi
													...
													String sql11 = "update passenger_info set status='RESERVED',seat_no='S" + i
															+ "' where PNR=" + pnr[wno] + " and seat_no='W" + num + "' ; ";
													...
													String sql12 = "update " + coach + " set " + s + "='" + pnr[wno]
															+ "' where train_no=" + trainno + " and dep_date='" + dep_date
															+ "'; ";
													...
													for (int k = 1; k <= no_wait; k++) {
														...
														String sql13 = "update " + coach + " set wait_" + k + "=" + pnr1[k]
																+ " where train_no=" + trainno + " and dep_date='" + dep_date
																+ "'; ";
														...
														String sql15 = "select p.PNR from passenger_info p, ticket_book t where t.pnr=p.pnr and t.dep_date='"
																+ dep_date + "' and p.seat_no='W" + (k) + "' and p.coach_no='"
																+ coach + "'";
														...
														if (rs.next()) {
															...
															if (newpnr != null) {
																//Updating passenger_info for the new status from waiting to reserved for the seat no
																String sql14 = "update passenger_info set status='WAITING',seat_no='W"
																		+ (k - 1) + "' where PNR=" + newpnr + " and seat_no='W"
																		+ (k) + "' ; ";
