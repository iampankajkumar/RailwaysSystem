		...
		<div id="templatemo_content">
			...
			<div>
				...
				<h2 style="height: 600px;">
					User Registration Completed for <span style="color: red;"> <%=_uname.toUpperCase()%>
					</span> with Email Id <span style="color: maroon;"> <%=_email%>
					</span><br /> <a href="./home.jsp"> OK </a>
				</h2>
			</div>
			<%
				} else {
			...
			<div>
				<br /> <br /> <br /> <br />
				<h2 style="height: 600px;">User Registration Error</h2>
			</div>
			<%
				}
			...
			<div>
				<br /> <br /> <br /> <br />
				<h2>
					Email Id <span style="color: maroon;"> <%=_email%>
					</span> Already Registered Try Another
				</h2>
			</div>
