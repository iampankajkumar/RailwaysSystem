			...
			<div
				...
				<div align="center">
					<form name="form1" action="./adminbook.jsp">
						...
						<br /> <label style="font-weight: bold; color: red;">
							Select A Date To View Bookings</label>
						<p>
							<input type="text" name="date" readonly="readonly"
								id="datepicker" title="YYYY/MM/DD" size="12" /> <img alt=""
								src="./jsDate/css/images/date.png" height="35px" width="35px"
								onclick="document.form1.date.focus()">
						</p>
						<input type="button" value="Search" onclick="valid();"> <br />
						<br />
						<div>
							<%
								tryblock : try {
												...
												String sql1 = "select distinct t.PNR, t.train_no, t.dep_date, t.adult, t.child, t.no_seats, t.board_station, t.dest_station, t.total_km, u.name from ticket_book t, reg_user u where t.user_id=u.user_id and t.book_date='"
														+ date + "' ";
												...
												out.println(
														"<th align='left' colspan='8' style='color:white'> Booking Details : </th> </tr>");
												out.println(
														"<tr bgcolor=#333333 style='color:white'>	<th> PNR No</th> <th> Train No</th> <th> Dep_Date</th> <th> No_Seats</th><th> Boarding Station</th><th> Destination Station</th><th> Distance</th><th> Booked By</th>	</tr>");
												...
												while (rs.next()) {
													...
													out.println("<td>" + rs.getInt(1) + "</td><td>" + rs.getString(2) + "</td><td>"
															...
															+ rs.getString(9) + "</td><td>" + rs.getString(10) + "</td>");
													out.println("</tr>");
												}
												out.println("</table>");
