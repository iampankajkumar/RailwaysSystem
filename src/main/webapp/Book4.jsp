...
<body onload="calc();">
	...
	<div id="templatemo_wrapper">
			...
			<div align="center">
				...
				<form name="form1" action="./Book5.jsp">
					...
					<table border="1" bordercolor=#333333>
						<tr bgcolor=#333333>
							<th colspan="6" align="left" style="color: white">Ticket
								Reservation :</th>
						</tr>
						<%
							int pnrno = 0;
						...
						<tr>
							<th>PNR NO :</th>
							<td><input type="text" name="pnrno" size="15"
								value="<%=pnrno%>" " tabindex="-1" /></td>
							<th>Date Of Booking :</th>
							<td><input name="date_book" type="text" readonly="readonly"
								size="15" value="<%=date_book%>" tabindex="-1" /></td>
							<th>Date Of Departure :</th>
							<td><input name="date_dep" type="text" readonly="readonly"
								size="15" value="<%=date_dep%>" tabindex="-1" /></td>
						</tr>
						<tr>
							<th>Train No :</th>
							<td><input type="text" name="tno" size="5"
								value="<%=rs.getString("train_no")%>" readonly="readonly"
								tabindex="-1" /></td>
							<th>Train Name :</th>
							<td><input type="text" size="15"
								value="<%=rs.getString("train_name")%>" readonly="readonly"
								tabindex="-1" /></td>
							<th>Type :</th>
							<td><input type="text" size="13"
								value="<%=rs.getString("type")%>" readonly="readonly"
								tabindex="-1" /></td>
						</tr>
						<tr>
							<th>Source Station :</th>
							<td><input type="text" size="13"
								value="<%=rs.getString("s_station_name")%>" readonly="readonly"
								tabindex="-1" /></td>
							<th>Destination Station :</th>
							<td><input type="text" size="13"
								value="<%=rs.getString("d_station_name")%>" readonly="readonly"
								tabindex="-1" /> <input name="km" type="hidden"
								value="<%=rs.getString("km")%>"></td>
							<th>Class :</th>
							<td><input type="text" size="13" value="<%=class1%>"
								readonly="readonly" tabindex="-1" /> <input name="clas"
								type="hidden" value="<%=clas%>"></td>
						</tr>
					...
					<input name="src" type="hidden" value='<%=srcid%>' /> <input
						name="des" type="hidden" value='<%=desid%>' />

					<table border="1" bordercolor=#333333>
						<tr bgcolor=#333333>
							<th align="left" colspan="6" style="color: white">Travel
								Details :</th>
						</tr>
						<tr>
							<th>Travel Date:</th>
							<td><input type="text" size="9" value="<%=date_dep%>"
								readonly="readonly" tabindex="-1" /></td>
							<th>No Of Adult Seats:</th>
							<td><input type="text" size="9" value="<%=adult%>"
								readonly="readonly" tabindex="-1" /></td>
							<th>No Of Child Seats:</th>
							<td><input type="text" size="9" value="<%=child%>"
								readonly="readonly" tabindex="-1" /></td>
						</tr>
						<tr>
							<th>Travel Km:</th>
							<td><input type="text" name="totalkm" size="9"
								value="<%=totalkm%>" readonly="readonly" tabindex="-1" /></td>
							<th>Boarding Station:</th>
							<td><input type="text" size="9" value="<%=source%>"
								readonly="readonly" tabindex="-1" /></td>
							<th>RESV. UPTO:</th>
							<td><input type="text" size="9" value="<%=dest%>"
								readonly="readonly" tabindex="-1" /></td>
						</tr>
					</table>
					...
					%>
					<input type="hidden" name="coach" value="<%=coach%>"> <input
						type="hidden" name="adult1" value="<%=adult1%>"> <input
						type="hidden" name="child1" value="<%=child1%>">
					<%
						km1 = Integer.parseInt(request.getParameter("totalkm"));
										...
										out.println(
												"<div align='left'>  <span align='left' style='color: red; font-size: 14pt;'>Coach No = "
														+ coach + " <br/> Total Km's = " + km1 + " kms <br/> Fare Per Seat = "
														+ price + " Rs </span> </div>");
										out.println("<br/>");
										...
										if (adult1 != 0) { //Executes only if the adults seats are present
											...
											out.print(
													"	<tr bgcolor=#333333> <th align='left' colspan='8' style='color:white'> Adult's Details :  </tr> ");
											out.print(
													"<tr> <th> No </th> <th> Seat No </th> <th> Name </th> <th> Sex </th> <th> Age </th>  <th> Senior Citizen </th> <th> Amount </th> <th> Status </th> </tr>");
											...
											loop: for (int i = 1; i <= adult1; i++) {
												...
												out.print("<td> <input name='seat" + i + "' type='text' value='" + _seat
														+ "' size='3' readonly='readonly' tabindex='-1' /> </td>");
												out.print("<td> <input name='name" + i + "' type='text' value='" + _name
														+ "' size='25' readonly='readonly' tabindex='-1'/> </td>");
												out.print("<td> <input name='sex" + i + "' type='text' value='" + _sex
														+ "' size='2' readonly='readonly' tabindex='-1'/> </td>");
												out.print("<td> <input name='age" + i + "' type='text' value='" + _age
														+ "' size='3' readonly='readonly' tabindex='-1'/> </td>");
												out.print("<td> <input name='senior" + i + "' type='text' value='" + _senior
														+ "' size='2' readonly='readonly' tabindex='-1'/> </td>");
												double amt = 0;
												if (_senior.equals("Y")) {
												...
												out.print("<td> <input id='amt1" + i + "' name='amt" + i + "' type='text' value='"
														+ amt + "' size='6' readonly='readonly' tabindex='-1'/> </td>");
												out.print("<td> <input name='status" + i + "' type='text' value='" + _status
										...
										if (child1 != 0) { //Executes only if the Children seats are present	
											out.print("<table border='1' bordercolor=#333333>");
											out.print(
													"<tr bgcolor=#333333> <th align='left' colspan='7' style='color:white'> Childeren Details : </th> </tr> ");
											out.print(
													"<tr> <th> No </th> <th> Seat No </th> <th> Name </th> <th> Sex </th> <th> Age </th> <th> Amount </th> <th> Status </th> </tr>");
					...
					<table>
						...
						<tr>
							<th>Total Amount</th>
							<td><input id="total2" name="total1" type="text"
								readonly='readonly' tabindex='-1' /></td>
						</tr>
						<!--     <tr>
		<td colspan="2"><input type="button" value="Generate Amount" onfocus="calc()" /></td>
						...
						<tr>
							<td colspan="2" align="center"><input id="credit2"
								type="text" maxlength="16" onkeyup="num(this)"
								onkeydown="num(this);" /></td>
						</tr>
						<tr>
							<td colspan="2" align="center"><input type="button"
								value="Conform And Print eTicket" onclick="validate()" /></td>
						</tr>
					</table>
				</form>
				<%
