					...
					<table border="1" bordercolor=#333333>
						...
						<tr>
							...
							<td><input type="text" name="pnrno" size="15"
								value=<%String sql1 = "select MAX(PNR) + 1 from ticket_book";
...
readonly="readonly"
							...
							<td><input name="date_book" type="text" readonly="readonly"
								size="15" value="<%=_date%>" tabindex="-1" /></td>
							<th>Date Of Departure :</th>
							<td><input name="date_dep" type="text" readonly="readonly"
								size="15" value="<%=date1%>" tabindex="-1" /></td>
						</tr>
						<tr>
							<th>Train No :</th>
							...
							<td><input type="text" size="15"
								...
								tabindex="-1" /></td>
							<th>Type :</th>
							<td><input name="type" type="text" size="13"
					...
					<table border="1" bordercolor=#333333>
						...
						<tr>
							<th>Travel Date:</th>
							<td><input type="text" size="9" value="<%=date1%>"
					...
					%>
					<input name="coach" type="hidden" value="<%=coach%>"> <input
						name="adult1" type="hidden" value="<%=adult1%>"> <input
						name="child1" type="hidden" value="<%=child1%>">
					<%
						if (adult1 != 0) { //Executes only if the adults seats are present
											out.print("<table border='1' bordercolor=#333333>");
											out.print(
													"	<tr bgcolor=#333333> <th align='left' colspan='4' style='color:white'> Adult's Details : </th> <th align='right' colspan='2' style='color:white'> Coach No = "
															+ coach + " </th>  </tr> ");
											out.print(
													"<tr> <th> No </th> <th> Seat No </th> <th> Name </th> <th> Sex </th> <th> Age </th>  <th> Senior Citizen </th> </tr>");

											int sno = 0; //To Innitialize the seat[] array
											for (int i = 1; i <= adult1; i++) {
												out.print("<tr><th> " + i + " </th>");
												out.print("<td> <input name='seat" + i + "' type='text' value=" + seat[sno]
														+ " size='4' readonly='readonly' tabindex='-1' /> </td>");
												out.print("<td> <input name='name" + i
														+ "' type='text' maxlength='30' onkeyup='alp1(this)' onkeydown='alp1(this)' /> </td>");
												out.print("<td> <select id='sex1" + i + "' name='sex" + i
												...
												out.println("<td align='center'> <input type='hidden' id='senior2" + i
														+ "' name='senior" + i + "' >");

												//Check Box For Front End View For Check and UnCheck At Run Time
												out.print(" <input type='checkbox' id='senior1" + i
										...
										if (child1 != 0) { //Executes only if the Child seats are present
											...
											out.print("<table border='1' bordercolor=#333333>");
											out.print(
													"	<tr bgcolor=#333333> <th align='left' colspan='3' style='color:white'> Children Details : </th> <th align='right' colspan='2' style='color:white'> Coach No = "
															+ coach + " </th>  </tr> ");
											out.print(
													"<tr> <th> No </th> <th> Seat No </th> <th> Name </th> <th> Sex </th> <th> Age </th> </tr>");

											int sno1 = adult1;//To start With The End Seat No After The Adults Seat
											for (int i = adult1 + 1; i <= (adult1 + child1); i++) {
												out.print("<tr><th> " + i + " </th>");
												out.print("<td> <input name='seat" + i + "' type='text' value=" + seat[sno1]
														+ " size='4' readonly='readonly' tabindex='-1' /> </td>");
												out.print("<td> <input name='name" + i
														+ "' type='text' maxlength='30' onkeyup='alp1(this)' onkeydown='alp1(this)'/> </td>");
												out.print("<td> <select name='sex" + i
														+ "'> <option value='M'> MALE </option> <option value='F'> FEMALE </option> </select> </td> ");
